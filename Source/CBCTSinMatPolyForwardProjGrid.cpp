...
void CBCTSinMatPolyForwardProjGrid::computePolyForwProjFoSp()
{
	cout << "加滤线栅有焦斑大小的正过程成像开始 ====>>>>" << endl;
	...
	// 初始化GPU
	cout << endl << "密度图像投影计算中 ===>>>" << endl;
	initDeviceSinMatFoSpSiGrid(d_mForwardProj, d_mCoordinate, mCTScanSystemInfo, mCTScanParas, h_mForwardProj);
